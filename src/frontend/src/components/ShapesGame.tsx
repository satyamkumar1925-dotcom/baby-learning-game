...
const shapes = [
  { emoji: "⭕", name: "Circle", hindi: "वृत्त" },
  { emoji: "⬛", name: "Square", hindi: "वर्ग" },
  { emoji: "🔺", name: "Triangle", hindi: "त्रिभुज" },
  { emoji: "🟦", name: "Rectangle", hindi: "आयत" },
  { emoji: "⭐", name: "Star", hindi: "तारा" },
  { emoji: "🔷", name: "Diamond", hindi: "हीरा" },
  { emoji: "❤️", name: "Heart", hindi: "दिल" },
  { emoji: "🔶", name: "Hexagon", hindi: "षट्भुज" },
  { emoji: "🌙", name: "Crescent", hindi: "अर्धचंद्र" },
  { emoji: "🔸", name: "Pentagon", hindi: "पंचभुज" },
];
...
export default function ShapesGame({ onBack }: { onBack: () => void }) {
  return (
    <GameLayout
      title="Shapes"
      emoji="⭐"
