...
const flowers = [
  { emoji: "🌸", name: "Cherry Blossom", hindi: "चेरी फूल" },
  { emoji: "🌹", name: "Rose", hindi: "गुलाब" },
  { emoji: "🌻", name: "Sunflower", hindi: "सूरजमुखी" },
  { emoji: "🌺", name: "Hibiscus", hindi: "हिबिस्कस" },
  { emoji: "🌼", name: "Daisy", hindi: "डेज़ी" },
  { emoji: "💐", name: "Bouquet", hindi: "गुलदस्ता" },
  { emoji: "🌷", name: "Tulip", hindi: "ट्यूलिप" },
  { emoji: "🪷", name: "Lotus", hindi: "कमल" },
  { emoji: "🌿", name: "Leaves", hindi: "पत्ते" },
  { emoji: "🍀", name: "Clover", hindi: "तिपतिया" },
];
